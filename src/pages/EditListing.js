...
function EditListing() {
    ...
    // Destructuring formData to easy use
    ...
    // Get Listing data to fill the form to edit
    //**********************************************/
    useEffect(()=>{
      setLoading(true)
    ...
    // Get user and set userRef to the user id
    //**********************************************/
    useEffect(() => {
      if (isMounted) {
    ...
    const onSubmit = async (e) =>{
      ...
      const storeImage = async (image) => {
        ...
        //Loop in the images array and run the storeImage func for every img. Will return the "downloadURL"
    ...
    // Cast input's types from the form
    //**********************************************/
    const onMutate = (e) => {
